export const en = {
  ...
  common: {
    ...
    trackMovements: 'Track stock movements and manage inventory levels',
  ...
  products: {
    ...
    stockPositive: 'Stock must be 0 or greater',
    minStockPositive: 'Min stock must be 0 or greater',
