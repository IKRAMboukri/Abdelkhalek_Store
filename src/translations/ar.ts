export const ar = {
  ...
  auth: {
    ...
    logout: 'تسجيل الخروج',
    fillAllFields: 'يرجى إدخال البريد الإلكتروني وكلمة المرور.',
    loginFailed: 'تعذر تسجيل الدخول. يرجى المحاولة مرة أخرى.',
    secureNote: 'جلستك محمية. الوصول مخصص للموظفين المصرح لهم فقط.',
  },
  nav: {
  ...
  categories: {
    ...
    selectParent: 'اختر تصنيفًا أبًا',
    parentRequired: 'يرجى اختيار تصنيف أب',
    noMainCategories: 'لا توجد تصنيفات رئيسية. أنشئ تصنيفًا رئيسيًا أولاً.',
    subcategoryCreated: 'تمت إضافة الفئة الفرعية بنجاح',
  ...
  sales: {
    ...
    avanceExceedsTotal: 'لا يمكن أن تتجاوز الدفعة المقدمة الإجمالي',
  ...
  settings: {
    ...
    removeLogo: 'إزالة',
    logoHelp: 'PNG أو JPG أو WEBP أو GIF أو SVG — بحد أقصى 5 ميغابايت. يُحفظ على الخادم.',
    invalidImageType: 'نوع الصورة غير مدعوم. استخدم PNG أو JPG أو WEBP أو GIF أو SVG.',
    imageTooLarge: 'الصورة كبيرة جدًا. الحد الأقصى 5 ميغابايت.',
    logoUploaded: 'تم تحميل الشعار بنجاح',
    logoRemoved: 'تمت إزالة الشعار',
    logoUploadFailed: 'فشل تحميل الشعار',
