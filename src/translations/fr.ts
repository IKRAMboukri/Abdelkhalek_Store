export const fr = {
  ...
  common: {
    ...
    trackMovements: 'Suivez les mouvements de stock et gérez les niveaux d\'inventaire',
  ...
  products: {
    ...
    stockPositive: 'Le stock doit être 0 ou plus',
    minStockPositive: 'Le stock minimum doit être 0 ou plus',
  ...
  inventory: {
    ...
    noLowStock: 'Aucun article à stock faible',
    summary: 'Résumé',
    movements: 'Mouvements',
    noMovements: 'Aucun mouvement de stock trouvé.',
  },
  ...
  notifications: {
    ...
    unread: 'Non lu',
    type: {
      low_stock: 'Alerte de Stock Faible',
